		...
		<div class="filter-container">
			<form id="category-filter-form" method="get" action="">
					<div class="first-filter">
						<h6 class="category-heading">
							Category
						</h6>
				
						<select name="category1" id="category1" class="cat-dropdown">
					...
					<div class="second-filter">
							...
							<select name="category2" id="category2" class="cat-dropdown">
								<option value="volvo">---Select the option---</option>	
								<?php 
								$args = array(
								...
								if ( ! empty( $product_tags ) && ! is_wp_error( $product_tags ) ) {
									foreach ( $product_tags as $tag ) {
										?>
										<option value="<?php echo esc_html( $tag->name ) ?>"><?php echo esc_html( $tag->name ); ?></option>
										<?php 
									}
								}	
							?>
